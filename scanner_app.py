...
st.markdown("""
    <style>
        .stButton>button {width: 100%; height: 80px !important; font-size: 28px !important; font-weight: bold; background-color: #007bff; color: white; border-radius: 15px;}
        [data-testid="stDataFrame"] {width: 100% !important;}
        .big-font {font-size: 24px !important; font-weight: bold;}
    </style>
""", unsafe_allow_html=True)

st.title("📈 Intrabullscanner22 | Google Sheet Integration")

# 2. Google Sheet से डेटा लोड करना
# नोट: Sheet -> File -> Share -> Publish to web -> .csv चुनें और यहाँ लिंक डालें
...
def get_symbols():
    try:
        ...
        st.error("Google Sheet लिंक चेक करें या उसमें 'Symbol' हेडर होना जरूरी है।")
